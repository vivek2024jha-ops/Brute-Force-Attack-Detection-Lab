...
Screenshot showing the isolated network configuration between the Kali Linux and Windows VMs.

<!-- Drag screenshot "01-lab-network-configuration" here -->

## Step 2 - Verify Network Connectivity

Screenshot showing successful network connectivity between the Kali Linux and Windows VMs.

<!-- Drag screenshot "02-Verify Network Connectivity" here -->

## Step 3 - Identify the RDP Service

Screenshot showing the Nmap scan identifying the RDP service on TCP port 3389.

<img width="1841" height="1035" alt="03-Identify the RDP Service" src="https://github.com/user-attachments/assets/ae705919-5538-4072-a7ce-c0a9418ec96c" />

## Step 4 - Verify RDP Connectivity

Screenshot showing the successful RDP connection from Kali Linux to the Windows workstation.

<img width="1917" height="991" alt="04-Verify RDP Connectivity" src="https://github.com/user-attachments/assets/25f055bc-bedb-42f0-921a-cb4ef3a5380b" />

## Step 5 - Event ID 4624 - Successful Logon

Screenshot showing a successful Windows authentication event.
...
## Step 6 - Controlled Authentication Testing

Screenshot showing the controlled authentication testing performed from Kali Linux.

<!-- Drag screenshot "06-Controlled Authentication Testing" here -->

## Step 7 - Event ID 4625 - Failed Logon

Screenshot showing a failed Windows authentication event.

<!-- Drag screenshot "07-Event ID 4625 – Failed Logon" here -->

Additional event details:

<!-- Drag screenshot "07-Event ID 4625 D1" here -->

Further event information:

<!-- Drag screenshot "07-Event ID 4625 D2" here -->

## Step 8 - Identify the Source IP Address

Screenshot showing the source IP address associated with the failed authentication activity.

<!-- Drag screenshot "08-Identify the Source IP Address" here -->

## Step 9 - Multiple Failed Authentication Attempts

Screenshot showing multiple failed authentication attempts recorded in the Windows Security Log.

<!-- Drag screenshot "09-Multiple Failed Authentication Attempts" here -->

Additional failed authentication information:

<!-- Drag screenshot "010-Multiple Failed Information" here -->
